...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("koda.http"), self.assertRaises(
            JsonRpcException,
            msg='koda.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('koda.http'), self.assertRaises(JsonRpcException, msg='koda.exceptions.ValidationError: The access token is invalid.'):
