...
from koda.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from koda.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'koda.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
