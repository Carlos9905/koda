...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('koda.models.unlink', 'koda.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('koda.addons.base.models.ir_rule', 'koda.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('koda.addons.mail.models.mail_thread', 'koda.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('koda.addons.mail.models.mail_thread', 'koda.addons.mail_group.models.mail_group_message', 'koda.models.unlink')
    @users('employee')
    ...
    @mute_logger('koda.addons.mail_group.models.mail_group')
    @users('employee')
