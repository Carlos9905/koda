...
from koda.tests.common import TransactionCase, users
from koda.addons.mail.tests.common import mail_new_test_user
from koda.exceptions import AccessError
from koda.tests import tagged
from koda.tools import mute_logger, convert_file
...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('koda.models.unlink', 'koda.addons.base.models.ir_model')
