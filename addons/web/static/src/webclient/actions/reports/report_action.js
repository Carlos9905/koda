...
import { Component, useRef, useSubEnv } from "@koda/owl";
 ...
 * It uses a feature to automatically create links to other koda pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
