...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    @mute_logger('koda.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'koda.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    @mute_logger('koda.addons.payment_adyen.controllers.main')
    @mute_logger('koda.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'koda.addons.payment_adyen.controllers.main.AdyenController'
