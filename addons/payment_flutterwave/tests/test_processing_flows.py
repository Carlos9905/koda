...
from koda.addons.payment_flutterwave.controllers.main import FlutterwaveController
...
class TestProcessingFlows(FlutterwaveCommon, PaymentHttpCommon):
    ...
    @mute_logger('koda.addons.payment_flutterwave.controllers.main')
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'koda.addons.payment_flutterwave.controllers.main.FlutterwaveController.'
