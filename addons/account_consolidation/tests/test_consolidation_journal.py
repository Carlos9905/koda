...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'koda.addons.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition._get_journal_lines_values')
    @patch(
        'koda.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._get_journal_lines_values')
