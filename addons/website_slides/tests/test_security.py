...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('koda.models', 'koda.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('koda.models.unlink', 'koda.addons.base.models.ir_rule', 'koda.addons.base.models.ir_model')
