...
class SaleOrder(models.Model):
    ...
    def _test_demo_generate_subscriptions(self):
        ...
        with patch('koda.addons.sale_subscription.models.sale_order.SaleOrder._process_invoices_to_send',
                  wraps=_mock_process_invoices_to_send),\
             patch('koda.addons.sale_subscription.models.sale_order.SaleOrder._subscription_commit_cursor',
                  wraps=_do_nothing),\
             patch('koda.addons.sale_subscription.models.sale_order.SaleOrder._subscription_rollback_cursor',
                  wraps=_do_nothing):
