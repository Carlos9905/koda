...
# koda-mailgate
#
# This program will read an email from stdin and forward it to koda. Configure
# a pipe alias in your mail server to use it, postfix uses a syntax that looks
# like:
#
# email@address: "|/home/koda/src/koda-mail.py"
#
# while exim uses a syntax that looks like:
#
# *: |/home/koda/src/koda-mail.py
#
...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="Odoo database name (default: %default)", default='koda')
