...
from koda.addons.microsoft_account.models.microsoft_service import DEFAULT_MICROSOFT_TOKEN_ENDPOINT
from koda.addons.microsoft_calendar.utils.microsoft_calendar import InvalidSyncToken
