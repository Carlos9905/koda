...
class RecurrenceRule(models.Model):
    ...
    def _write_from_microsoft(self, microsoft_event, vals):
        ...
        new_event_values = self.env["calendar.event"]._microsoft_to_koda_values(microsoft_event)
    ...
    @api.model
    def _microsoft_to_koda_values(self, microsoft_recurrence, default_reminders=(), default_values=None, with_ids=False):
