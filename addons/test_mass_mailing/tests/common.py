...
<t t-set="httpurl" t-value="'https://www.koda.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.koda.tz/my/{{object.name}}">https://www.koda.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.koda.be">https://www.koda.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@koda.com">test@koda.com</a></span>
<p>Stop spam ? <a id="url8" role="button" href="/unsubscribe_from_list">Ok</a></p>
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{object.display_name}} this is a mass SMS with two links http://www.koda.com/smstest and http://www.koda.com/smstest/{{object.id}}',
            'sms_force_send': True,
