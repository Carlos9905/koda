...
from koda.modules.module import get_module_root, MANIFEST_NAMES
from koda.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            koda.tools.config['init']['base'] = True
