...
class Shell(Command):
    ...
    def init(self, args):
        ...
        koda.cli.server.report_configuration()
        koda.service.server.start(preload=[], stop=True)
    ...
    def shell(self, dbname):
        ...
        if dbname:
            ...
            with registry.cursor() as cr:
                ...
                ctx = koda.api.Environment(cr, uid, {})['res.users'].context_get()
                env = koda.api.Environment(cr, uid, ctx)
                local_vars['env'] = env
