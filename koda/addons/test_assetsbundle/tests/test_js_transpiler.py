...
class TestJsTranspiler(TransactionCase):
    ...
    def test_01_alias(self):
        ...
        expected_result = """koda.define('@test_assetsbundle/alias', async function (require) {
'use strict';
let __exports = {};
...
koda.define(`test_assetsbundle.Alias`, async function(require) {
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/classes', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/comments', async function (require) {
'use strict';
let __exports = {};
/**
 * This is a comment
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/functions', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/import', async function (require) {
'use strict';
let __exports = {};
/**
 * import { Dialog, Notification } from "../src/Dialog";
...
import d from "@tests";"""
        ...
        expected_result = """koda.define('@test_assetsbundle', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/list', async function (require) {
'use strict';
let __exports = {};
...
"""
        ...
        expected_result = """koda.define('@test_assetsbundle/variables', async function (require) {
'use strict';
let __exports = {};
