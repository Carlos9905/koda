...
QWeb is the primary templating engine used by koda. It is an XML templating
...
The generated code uses ``user_has_groups`` koda method.
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since koda 17.0, keep the value empty and configure the "
